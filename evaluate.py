...
def main():
    ...
    print(f'  Client model split layer: 3')
    print(f'  Smashed data partitioning: 3x3 grid')
    print(f'  Protected partition: central (1 partition)')
    print(f'  Original partitions: surrounding (8 partitions)')
